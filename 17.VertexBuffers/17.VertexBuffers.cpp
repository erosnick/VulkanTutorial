...
{
	auto vertexShaderCode = readFile("../Assets/Shaders/VertexBuffer.vert.spv");
	auto fragementShaderCode = readFile("../Assets/Shaders/VertexBuffer.frag.spv");
...
void HelloTriangleApplication::createVertexBuffer()
{
	...
	VkCheck(vkAllocateMemory(device, &memoryAllocateInfo, nullptr, &vertexBufferMemory), "Failed to allocate vertex buffer memory!");
	...
	memcpy_s(data, static_cast<size_t>(bufferCreateInfo.size), vertices.data(), static_cast<size_t>(bufferCreateInfo.size));
