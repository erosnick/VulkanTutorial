...
struct Vertex
{
	...
	static std::array<VkVertexInputAttributeDescription, 4> getAttributeDescriptions()
	{
		...
		vertexInputAttributeDescriptions[3].offset = offsetof(Vertex, color);
...
{
	auto vertexShaderCode = readFile("../Assets/Shaders/Model.vert.spv");
	auto fragementShaderCode = readFile("../Assets/Shaders/Model.frag.spv");
